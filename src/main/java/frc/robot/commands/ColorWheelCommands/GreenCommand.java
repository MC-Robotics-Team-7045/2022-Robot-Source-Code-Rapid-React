...
public class GreenCommand extends CommandBase {
  private final ColorWheelSubsystem m_ColorWheelSubsystem;
  /**
   * Creates a new BlueCommand.
   */
  public GreenCommand(final ColorWheelSubsystem colorWheelSubsystem) {
  ...
  public void execute() {
    ...
    if (detectedColor.blue > 0.2 && detectedColor.green > 0.5 && detectedColor.red < 0.2) {
