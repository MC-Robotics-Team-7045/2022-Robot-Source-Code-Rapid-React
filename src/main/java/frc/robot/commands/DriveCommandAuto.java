...
public class DriveCommandAuto extends CommandBase {
   ...
   */
  public DriveCommandAuto(DriveTrain driveTrain, DoubleSupplier move, DoubleSupplier turn, DoubleSupplier throttle) {
