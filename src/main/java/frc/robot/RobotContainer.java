...
public class RobotContainer {
  ...
  private void configureButtonBindings() {
    ...
    //final JoystickButton cylinderExtend = new JoystickButton(joystick, Constants.JOYSTICK_BUTTON_CYLINDER_FWD);
    //final JoystickButton cylinderRetract = new JoystickButton(joystick, Constants.JOYSTICK_BUTTON_CYLINDER_REV);
    //final JoystickButton cylinderControl = new JoystickButton(joystick, Constants.JOYSTICK_BUTTON_CYLINDER);
