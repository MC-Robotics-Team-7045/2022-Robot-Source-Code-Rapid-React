...
//Shooter Constants
   ...
   //Rated freespin is 5310. With mounted motor and 1:1.92 gearbox & 4 stealth wheels ~8000rpm
   //public static final double kShooterTargetRPS = 5310*1.92*kShooterSpeed/60; //convert RPM to RPS to set Target
   public static final double kShooterMaxRPM = 8000;
   public static final double kShooterTargetRPS = kShooterMaxRPM*kShooterSpeed/60; //convert RPM to RPS to set Target
   ...
   public static final int kShooterEncoderPPR = 360; //20 pulses per channel per revolution (CIM Encoder), 360 CPR for E4T Mini Optical Encoder
   ...
   //public static final double kShooterEncoderDistancePerPulse =   Math.PI*4.0/360.0;       // Distance units with 4" Wheel
